<?php
namespace Infochy\InfochyFeeditexample\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class Infochy\InfochyFeeditexample\Controller\MyDataController.
 *
...
class MyDataControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    ...
    /**
     * @var \Infochy\InfochyFeeditexample\Controller\MyDataController
     */
    protected $subject = NULL;

    public function setUp()
    {
        $this->subject = $this->getMock('Infochy\\InfochyFeeditexample\\Controller\\MyDataController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
    }
    ...
    public function listActionFetchesAllMyDatasFromRepositoryAndAssignsThemToView()
    {
        ...
        $myDataRepository = $this->getMock('Infochy\\InfochyFeeditexample\\Domain\\Repository\\MyDataRepository', array('findAll'), array(), '', FALSE);
    ...
    {
        $myData = new \Infochy\InfochyFeeditexample\Domain\Model\MyData();
    ...
    public function createActionAddsTheGivenMyDataToMyDataRepository()
    {
        ...
        $myDataRepository = $this->getMock('Infochy\\InfochyFeeditexample\\Domain\\Repository\\MyDataRepository', array('add'), array(), '', FALSE);
    ...
    public function updateActionUpdatesTheGivenMyDataInMyDataRepository()
    {
        ...
        $myDataRepository = $this->getMock('Infochy\\InfochyFeeditexample\\Domain\\Repository\\MyDataRepository', array('update'), array(), '', FALSE);
    ...
    public function deleteActionRemovesTheGivenMyDataFromMyDataRepository()
    {
        ...
        $myDataRepository = $this->getMock('Infochy\\InfochyFeeditexample\\Domain\\Repository\\MyDataRepository', array('remove'), array(), '', FALSE);
