...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3seditor/mod2/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3seditor/mod2/index.php']);
}
...
$SOBE->setT3SFolder('configlibrary/ts');
$SOBE->setT3STitle('Editor: TypoScript');
$SOBE->main();
$SOBE->printContent();
?>