...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3seditor/mod4/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3seditor/mod4/index.php']);
}
...
$SOBE->setT3SFolder('configlibrary/tsuser');
$SOBE->setT3STitle('Editor: TSconfig-User');
$SOBE->main();
$SOBE->printContent();
