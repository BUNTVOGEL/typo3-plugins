...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3seditor/mod5/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3seditor/mod5/index.php']);
}
...
$SOBE->setT3SFolder('resources');
$SOBE->setT3STitle('Editor: Layout');
$SOBE->main();
$SOBE->printContent();
