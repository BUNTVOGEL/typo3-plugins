...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3seditor/mod6/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3seditor/mod6/index.php']);
}
...
$SOBE->setT3SFolder('t3sinstalltool');
$SOBE->setT3STitle('Editor: T3S Setup Config');
$SOBE->main();
$SOBE->printContent();
