<?php
namespace Infochy\InfochyCobject\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class Infochy\InfochyCobject\Controller\DataController.
 *
...
class DataControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Infochy\InfochyCobject\Controller\DataController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Infochy\\InfochyCobject\\Controller\\DataController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllDatasFromRepositoryAndAssignsThemToView()
	{
		...
		$dataRepository = $this->getMock('Infochy\\InfochyCobject\\Domain\\Repository\\DataRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$data = new \Infochy\InfochyCobject\Domain\Model\Data();
	...
	public function createActionAddsTheGivenDataToDataRepository()
	{
		...
		$dataRepository = $this->getMock('Infochy\\InfochyCobject\\Domain\\Repository\\DataRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenDataInDataRepository()
	{
		...
		$dataRepository = $this->getMock('Infochy\\InfochyCobject\\Domain\\Repository\\DataRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenDataFromDataRepository()
	{
		...
		$dataRepository = $this->getMock('Infochy\\InfochyCobject\\Domain\\Repository\\DataRepository', array('remove'), array(), '', FALSE);
